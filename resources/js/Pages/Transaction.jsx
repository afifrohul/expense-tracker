    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `/transaction/update/${editData.id}`,
                {
                    description: description,
                    category: category,
                    type: type,
                    ...
                    <span
                        className={`${
                            row.type === "expense"
                                ? "bg-red-600"
                                : "bg-green-600"
                        } p-1 text-white text-sm rounded-md`}
                    >
                        {row.type}
                    </span>
                </div>
            ...
            cell: (row) => (
                <div className="flex gap-2">
                    <div className="flex gap-1">
                        <div
                            className="p-2 w-fit rounded text-white bg-yellow-500 hover:bg-yellow-600 duration-150 hover:cursor-pointer"
        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="bg-white rounded-lg border border-slate-300 p-4 text-sm">
                <div className="flex justify-between items-center">
                    ...
                    <div
                        className="bg-blue-500 rounded px-3 py-2 text-white hover:bg-blue-600 duration-150 hover:cursor-pointer"
                ...
                <div className="text-end">
                    ...
                    <DataTable
                        ...
                        progressComponent={
                            <BiLoaderCircle className="m-6 text-xl" />
                        }
                        pagination
                        paginationServer
            ...
            {showModal && (
                <div className="fixed z-[999] inset-0 overflow-y-auto">
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        {/* Overlay */}
                        <div
                            className={`fixed inset-0 bg-gray-500 transition-opacity ease-in-out duration-100 ${
                        ...
                        {/* Modal Content */}
                        <div
                            className={`inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all ease-in-out duration-100 sm:my-8 sm:align-middle sm:max-w-lg sm:w-full 
                        ${
                            isVisible
